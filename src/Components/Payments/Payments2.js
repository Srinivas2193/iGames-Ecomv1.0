...
export const Payments2 = ({cartItems,setCartItem}) => {
  ...
  return (
    <div>
      <div className="w-3/6 h-auto my-5 shadow-2xl ml-96 bg-slate-400 rounded-2xl ">
              ...
              <div className="">
                ...
                <div className="cartItemsContainer">

                  {
                    ...
                    <img
                      src={res.images} alt={res.name}
                      className="w-40 h-40 ml-12 rounded-2xl"
                    />
                    <h1 className="mt-8 ml-10 text-xl font-medium">{res.name}</h1>
                    <p className="mt-1 ml-10 text-xl font-medium ">
                      Price ${res.price}  <span className="ml-3 font-normal text-red-500 text-1xl"><s>${res.strprice}</s></span>
                    </p>
                  </div>
                  </div>
                        </>
